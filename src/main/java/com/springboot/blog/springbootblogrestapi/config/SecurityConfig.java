    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        .antMatchers(HttpMethod.POST, "/api/v1/posts/**").hasRole("ADMIN")
                        .antMatchers(HttpMethod.PUT, "/api/v1/posts/**").hasRole("ADMIN")
                        .antMatchers(HttpMethod.DELETE, "/api/v1/posts/**").hasRole("ADMIN")
